...
//clave de la api : 84ddb3c6a8969d1786d688ad308fe0d3
    class ControladorBusqueda {
        ...
        public static function pintarBusquedaGenero($id){
            ...
            $url = "https://api.themoviedb.org/3/discover/tv?with_genres=$id+&api_key=84ddb3c6a8969d1786d688ad308fe0d3&language=es-Es";
        ...
        public static function pintarEnDetalle($id){
            $url = "https://api.themoviedb.org/3/tv/$id?api_key=84ddb3c6a8969d1786d688ad308fe0d3&language=es-Es";
            $resultado = file_get_contents($url, false);
            if ($resultado === false) {
                echo "Error haciendo petición";
                exit;
        ...
        public static function buscarGenero($serie){//PARA BUSCAR LOS GENEROS A LOS QUE PERTENECE CADA SERIE
            $url = "https://api.themoviedb.org/3/genre/tv/list?api_key=84ddb3c6a8969d1786d688ad308fe0d3&language=es-Es";
            $resultado = file_get_contents($url, false);
            if ($resultado === false) {
                echo "Error haciendo petición";
                exit;
